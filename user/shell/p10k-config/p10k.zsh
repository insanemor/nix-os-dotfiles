# Generated by Powerlevel10k configuration wizard on 2021-01-30 at 10:28 -03.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 05135.
# Wizard options: powerline, classic, unicode, dark, angled separators, blurred heads,
# blurred tails, 2 lines, disconnected, full frame, sparse, concise, transient_prompt,
...
() {
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION=$'\uf31c' #'\uf314'  f31c  f303
